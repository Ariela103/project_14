...
static const Operation operations[OP_SIZE] = {
    {0x0001, "mov", {1, 1, 1, 1}, {0, 1, 1, 1}},
    {0x0002, "cmp", {1, 1, 1, 1}, {1, 1, 1, 1}},
    {0x0004, "add", {1, 1, 1, 1}, {0, 1, 1, 1}},
    {0x0004, "sub", {1, 1, 1, 1}, {0, 1, 1, 1}},
    {0x0010, "lea", {0, 1, 1, 0}, {0, 1, 1, 1}},
    {0x0020, "clr", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {0x0020, "not", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {0x0020, "inc", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {0x0020, "dec", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {0x0200, "jmp", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {0x0200, "bne", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {0x1000, "red", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {0x2000, "prn", {0, 0, 0, 0}, {1, 1, 1, 1}},
    {0x0200, "jsr", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {0x4000, "rts", {0, 0, 0, 0}, {0, 0, 0, 0}},
    {0x8000, "stop", {0, 0, 0, 0}, {0, 0, 0, 0}},
};
