...
static const Operation operations[OP_SIZE] = {
    ...
    {4, "lea", {0, 1, 0, 0}, {0, 1, 1, 1}},
    {5, "clr", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {6, "not", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {7, "inc", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {8, "dec", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {9, "jmp", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {10, "bne", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {11, "red", {0, 0, 0, 0}, {0, 1, 1, 1}},
    {12, "prn", {0, 0, 0, 0}, {1, 1, 1, 1}},
    {13, "jsr", {0, 0, 0, 0}, {0, 1, 1, 0}},
    {14, "rts", {0, 0, 0, 0}, {0, 0, 0, 0}},
    {15, "stop", {0, 0, 0, 0}, {0, 0, 0, 0}},
};
